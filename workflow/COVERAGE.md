...
| JOB-010 | worker | `Worker.Run` | half-lease boundary, success, bounded handler errors, retry, ordinary and legacy nil panic, cancellation, heartbeat, reconciliation, custom-Store rejection, PostgreSQL | covered |
...
Unit statement coverage is 97.5% at exact implementation source `389915b`;
`callHandler` and `validateStoredJob` are 100% covered. The unchanged PostgreSQL integration suite
